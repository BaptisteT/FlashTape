...
- (void)createClassWithDictionary:(NSDictionary*)data name:(NSString*)name
{
    ...
    */
    ...
    NSLog(@"Created file to...[%@ / %lu]", filePathData, (unsigned long)[unarchiveData count]);
}
...
- (NSDictionary*)mappingObject:(NSDictionary*)parsedJSONData
{
    ...
    NSLog(@"- countryCodeToRegionCodeMap count [%lu]", (unsigned long)[countryCodeToRegionCodeMap count]);
    NSLog(@"- countryToMetadata          count [%lu]", (unsigned long)[countryToMetadata count]);
