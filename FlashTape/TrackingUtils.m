...
+ (void)trackEvent:(NSString *)eventName properties:(NSDictionary *)properties
{
    ...
    NSArray *arrayWithoutMixpanelEventTracking = @[EVENT_VIDEO_SEEN, EVENT_MESSAGE_READ, EVENT_CAMERA_FLIP_CLICKED, EVENT_CAPTION_CLICKED, EVENT_FRIEND_BUTTON_CLICKED];
